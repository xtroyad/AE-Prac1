...
```{r}
par(mfrow=c(1,3))
plot(prostate$svi, prostate$lcavol, xlab="svi", ylab="lcavol")
plot(prostate$svi, prostate$lcp, xlab="svi", ylab="lcp")
plot(prostate$svi, prostate$lpsa, xlab="svi", ylab="lpsa")
```
