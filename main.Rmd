...
Para realizar las predicciones usando los modelos de **Ridge** y **Lasso** utilizaremos la librería `glmnet`. Primero preparamos nuestro conjunto de datos y creamos el *training set*. Para crear nuestro training set utilizaremos el 70% de las entradas de nuestro conjunto de datos.
...
# con los mismos datos pseudo-aleatorios
set.seed(27) 
